...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('career-chat/{chatSession}/chat', [ChatSessionController::class, 'chat'])->middleware('ai.access:chat_message')->name('career-chat.chat');
    Route::post('career-chat/{chatSession}/extract', [ChatSessionController::class, 'extract'])->middleware('ai.access:experience_extract')->name('career-chat.extract');
