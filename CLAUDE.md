...
- `laravel-cloud` — Manages the CareerForge production deployment on Laravel Cloud. Activate when deploying, running artisan commands on production, viewing logs, managing environment variables, or interacting with Laravel Cloud infrastructure.
